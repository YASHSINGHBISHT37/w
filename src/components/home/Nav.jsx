    ...
    return (
        <div className='w-screen h-auto fixed z-[999] flex justify-center backdrop-blur-[1vw]'>
            ...
            <nav className="Menu w-90 h-auto py-2 flex items-center rounded-b-[1vh]">
                ...
                <div className='SearchBar w-full flex justify-between items-center bg-[#1a1b1a]/40 backdrop-blur-2xl rounded-full' style={{
                    ...
                    <div className=' relative inputSearch w-full h-9 flex justify-center items-center border-white/80'>
                        ...
                        <ul className={`suggestions absolute w-80 h-auto top-10 rounded-2xl bg-[#1a1b1a]/58 backdrop-blur-2xl ${suggestions.length === 0 ? '' : 'border-1 border-white/50'}`}>
